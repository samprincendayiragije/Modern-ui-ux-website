const testimonials = [
    {
        name: 'Ndayiragije samuel prince',
        role: 'Senior Developer',
        image: '/vite.svg',
        content: 'This Ai powered development has revolutionized how we write code . The intelligent suggestions save us hours everyday.'
    },
    {
        name: 'Ndayiragije samuel prince',
        role: 'Senior Developer',
            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12 lg:gap-16">
                    ...
                    <div className="lg:w-1/2 w-full text-center  lg:text-left">
                        ...
                        <p className="text-gray-400 text-base mb-10 sm:mb-15 sm:text-lg max-w-2xl mx-auto">Everything you need to build , Test, and deploy applications with Ai-powerd development tools.</p>
                            </div>
